...
// Combined layers - exported for use in other components
export const CombinedLogo = ({ width = 150, height = 150, className = "" }: { width?: number; height?: number; className?: string }) => {
    // Configuration parameters
    const centerX = 100;
    const centerY = 100;
    const outerRadius = 90;
